                 ...
                 <div class="clearfix">
                     ...
                     <div class="top-left">
                         ...
                         <div class="social-icon">
                             <a href="#"><span class="fab fa-facebook-f fa-x"></span></a>
                             <a href="#"><span class="fab fa-twitter fa-x"></span></a>
                             <a href="#"><span class="fab fa-google fa-x"></span></a>
                             <a href="#"><span class="fab fa-pinterest fa-x"></span></a>
             ...
             <ul class="navigation clearfix">
                 <li class="current dropdown"><a href="#">Home</a>
                     <ul>
                         ...
                         <li><a href="index-3.php">Homepage Three</a></li>
                         <li class="dropdown"><a href="#">Headers Style</a>
                             <ul>
                 ...
                 <li class="dropdown"><a href="#">Our Cars</a>
                     <ul>
                         <li><a href="cars-grid.php">Cars Grid</a></li>
                         <li><a href="cars-list.php">Cars List</a></li>
                         <li><a href="car-single.php">Car Single</a></li>
                         <li><a href="booking.php">Booking</a></li>
                         <li><a href="confirmation.php">Confirmation</a></li>
                     </ul>
                 </li>
