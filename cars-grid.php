...
<html><head>
<meta charset="utf-8">
<title>Zagreb HTML Template | Cars Grid</title>
<!-- Stylesheets -->
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    ...
                    <section class="cars-info-section grid-view">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="right-column pull-right col-md-8 col-sm-7 col-xs-12">
                                	<div class="viewed-box">
                                    	<a href="cars-grid.php" class="active icon flaticon-layout"></a>
                                        <a href="cars-list.php" class="icon flaticon-list"></a>
                                    </div>
                        ...
                        <div class="row clearfix">
                        	...
                        	<!--car info block-->
                        	<div class="car-info-block col-md-6 col-sm-6 col-xs-12">
                            	<div class="inner-box">
                                	<div class="image">
